...
public class RecordConverterTest {
    ...
    void testUserToProto() {
        ...
        assertEquals(now.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getCreatedAt()).toEpochMilli());
        assertEquals(now.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getUpdatedAt()).toEpochMilli());
    }
    ...
    void testApiKeyToProto() {
        ...
        assertEquals(expiresAt.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getExpiresAt()).toEpochMilli());
        assertEquals(now.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getLastUsedAt()).toEpochMilli());
        assertEquals(now.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getCreatedAt()).toEpochMilli());
        assertEquals(now.toEpochMilli(), DbUtil.fromProtoTimestamp(proto.getUpdatedAt()).toEpochMilli());
        assertEquals(createdById, UuidUtil.fromProtoBytes(proto.getCreatedById()).getValue());
        assertEquals(updatedById, UuidUtil.fromProtoBytes(proto.getUpdatedById()).getValue());
