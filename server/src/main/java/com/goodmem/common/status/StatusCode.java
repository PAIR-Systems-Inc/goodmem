...
/**
 * Status codes that correspond to both gRPC status codes and HTTP status codes. This provides a
 * standardized set of error codes that can be used across different transport protocols.
 */
  ...
  public static StatusCode fromHttpStatus(int httpStatusCode) {
    switch (httpStatusCode) {
      case 200:
        return OK;
      case 400:
        return INVALID_ARGUMENT; // Could also be OUT_OF_RANGE or FAILED_PRECONDITION
      case 401:
      ...
      case 404:
        return NOT_FOUND;
      case 409:
        return ALREADY_EXISTS; // Could also be ABORTED
      case 429:
        return RESOURCE_EXHAUSTED;
      case 499:
        return CANCELLED;
      case 500:
        return INTERNAL; // Could also be UNKNOWN or DATA_LOSS
      case 501:
