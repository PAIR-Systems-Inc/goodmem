...
public final class StatusOr<T> {
    ...
    /**
     * Creates a StatusOr from an Optional. If the Optional is empty, returns a StatusOr
     * with a NOT_FOUND status. Otherwise, returns a StatusOr with the value.
     * 
    ...
    public static <T> StatusOr<T> fromOptional(Optional<T> optional, String errorMessage) {
        return optional.map(StatusOr::ofValue)
    ...
    /**
     * Applies a function that returns a StatusOr to the value if this StatusOr is OK,
     * otherwise returns a StatusOr with the same error.
     * 
     * @param mapper the function to apply to the value
    ...
    /**
     * Applies a function that might throw to the value if this StatusOr is OK,
     * catching any exceptions and converting them to a StatusOr.
     * 
     * @param mapper the function to apply to the value
