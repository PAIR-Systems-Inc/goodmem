 ...
 * @param processingStatus The processing status (e.g., "PENDING", "PROCESSING", "COMPLETED",
 *     "FAILED")
...
public record Memory(
  ...
  public goodmem.v1.MemoryOuterClass.Memory toProto() {
    goodmem.v1.MemoryOuterClass.Memory.Builder builder =
        goodmem.v1.MemoryOuterClass.Memory.newBuilder()
