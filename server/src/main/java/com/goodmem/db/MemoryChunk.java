...
public record MemoryChunk(
    ...
    public MemoryChunk withVectorStatus(String newStatus) {
        return new MemoryChunk(
                chunkId, memoryId, chunkSequenceNumber, chunkText, embeddingVector,
                newStatus, startOffset, endOffset, createdAt, updatedAt, createdById, updatedById);
    }
    ...
    public MemoryChunk withEmbeddingVector(float[] newVector) {
        return new MemoryChunk(
                chunkId, memoryId, chunkSequenceNumber, chunkText, newVector,
                vectorStatus, startOffset, endOffset, createdAt, updatedAt, createdById, updatedById);
    }
    ...
    public int hashCode() {
        int result = java.util.Objects.hash(
                chunkId, memoryId, chunkSequenceNumber, chunkText, vectorStatus,
                startOffset, endOffset, createdAt, updatedAt, createdById, updatedById);
    ...
    public String toString() {
        return "MemoryChunk[" +
                ...
                ", chunkText='" + (chunkText != null ? chunkText.substring(0, Math.min(30, chunkText.length())) + "..." : null) + '\'' +
                ", embeddingVector=" + (embeddingVector != null ? "[" + embeddingVector.length + " elements]" : null) +
