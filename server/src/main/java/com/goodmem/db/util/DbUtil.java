...
public final class DbUtil {
    ...
    /**
     * Default vector size (dimensions) for embeddings.
     * The OpenAI Ada-002 model uses 1536 dimensions.
     */
     ...
     * use Jackson or another JSON library to parse the JSONB string.
     */
    @Nonnull
     ...
     * 
     * <p>PostgreSQL pgvector stores vector data in a binary format.
     * This method extracts it and converts it to a float array.
     */
    @Nonnull
