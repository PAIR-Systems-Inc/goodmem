 ...
 *   <li>Each record class has a corresponding helper class with a plural name (e.g., {@code Users}, {@code Spaces})
 *   <li>Helper classes provide static methods for common database operations
 *   <li>Database operations return {@code StatusOr<T>} to handle either success with a value or failure with a status
 * </ul>
 * 
 * <p>All record classes include a method to convert the record to its corresponding Protocol Buffer message.
 */
